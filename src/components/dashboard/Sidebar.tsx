...
function Sidebar({ sidebarOpen, setSidebarOpen }: SidebarProps) {
  ...
  const getFilteredMenuItems = (): MenuItem[] => {
    ...
    const allItems: MenuItem[] = [
      ...
      { href: "/dashboard/AllUser", icon: <Calendar size={18} />, label: "Usuarios", group: "Administrativo", roles: [1, 2] },
      { href: "/dashboard/allPatient", icon: <User size={18} />, label: "Pacientes", group: "Administrativo", roles: [1, 2] },
      { href: "/dashboard/MyDentalAppointment", icon: <FileText size={18} />, label: "Citas", group: "Clínico", roles: [4] },
